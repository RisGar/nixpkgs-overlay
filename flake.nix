{
  ...
  outputs = inputs: {
    overlays.default = final: prev: {
      ...
      print-cli-rs = prev.callPackage inputs.print-cli-rs { };
      nixln-edit = prev.callPackage inputs.nixln-edit { };
      ocrtool-mcp = prev.callPackage inputs.ocrtool-mcp { };
      nerdfont-cheatsheet = prev.callPackage inputs.nerdfont-cheatsheet { };
